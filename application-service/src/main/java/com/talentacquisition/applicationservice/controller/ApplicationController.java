...
public class ApplicationController {
    ...
    public ResponseEntity<ApplicationResponse> rejectCandidate(
            @PathVariable("id") Long id,
            @RequestHeader(value = "X-User-Id", required = false) Long userHeaderId,
            @RequestHeader(value = "X-Candidate-Id", required = false) Long candidateHeaderId,
            @RequestHeader(value = "X-User-Roles", required = false) String rolesHeader,
        ...
        log.info("Rejecting application id={} by callerId={}, roles={}", id, callerId, roles);
        ApplicationResponse response = applicationService.rejectCandidate(id, callerId, roles);
        return ResponseEntity.ok(response);
    }
